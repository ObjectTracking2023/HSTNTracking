...
def run(settings):
    ...
    settings.center_jitter_factor = {'train': 3, 'test': 4.5, 'mmr': 3}
    settings.scale_jitter_factor = {'train': 0.25, 'test': 0.5, 'mmr': 0.25}
    ...
    optimizer = optim.Adam([{'params': actor.net.classifier.filter_initializer.parameters(), 'lr': 5e-5},
                            ...
                            {'params': actor.net.neck.parameters(), 'lr': 2e-5},
                            {'params': actor.net.channelatt.parameters(), 'lr': 2e-5},
                            {'params': actor.net.spatialatt.parameters(), 'lr': 2e-5},
                            {'params': actor.net.memory.parameters(), 'lr': 2e-5}],
                           lr=2e-4)
