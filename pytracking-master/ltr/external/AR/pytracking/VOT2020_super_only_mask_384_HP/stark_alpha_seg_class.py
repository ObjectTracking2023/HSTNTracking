...
from ltr.external.AR.pytracking.vot20_utils import *
...
class STARK_ALPHA_SEG(object):
    def __init__(self, tracker_name='stark_s', para_name='baseline',
        ...
        refine_path = os.path.join('/home/zhanghc/1.1 shuping/shupingwenjian/1.TCSVT/MGSiamAtt/MGSiamAtt/ltr.external/AR/ltr/checkpoint/ARcm_coco_seg/ARnet_seg_mask_ep0040.pth')
    ...
    def initialize(self, img_RGB, mask):
        ...
        _ = self.stark.initialize(img_RGB, region)
